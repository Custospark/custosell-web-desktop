...
export const PIPELINE = {
  ...
  BOARD_DUPLICATE: (boardRef: string | number) => `/pipeline/boards/${boardRef}/duplicate`,
  BOARD_KANBAN: (boardRef: string | number) => `/pipeline/boards/${boardRef}/kanban`,
  BOARD_CALENDAR: (boardRef: string | number) => `/pipeline/boards/${boardRef}/calendar`,
  ALL_BOARDS_CALENDAR: '/pipeline/calendar',
  BOARD_BACKGROUND: (boardRef: string | number) => `/pipeline/boards/${boardRef}/background`,
  BOARD_IMPORT_TEMPLATE: (boardRef: string | number) => `/pipeline/boards/${boardRef}/import-template`,
  BOARD_IMPORT: (boardRef: string | number) => `/pipeline/boards/${boardRef}/import`,
...
export const ACCOUNTING = {
  ...
  COA_IMPORT_TEMPLATE: '/chart-of-accounts/import-template',
  COA_IMPORT: '/chart-of-accounts/import',
  COA_EXPORT: '/chart-of-accounts/export',
  ...
  JOURNAL_ENTRIES_IMPORT_TEMPLATE: '/journal-entries/import-template',
  JOURNAL_ENTRIES_IMPORT: '/journal-entries/import',
  JOURNAL_ENTRIES_EXPORT: '/journal-entries/export',
