...
## How is this different from just using a cash register or Excel?

| You right now | With Custosell |
|--------------|----------------|
| Manual receipt book | Digital receipts + PDF, printed or emailed |
| Notebook for credit customers | Customer profiles with purchase history & balances |
| Stock counted by hand | Real-time stock levels, low-stock alerts |
| End-of-day pencil math | Dashboard with profit, top products, VAT summary |
| Pay someone to do books | Double-entry accounting built in |
| Separate POS + accounting + payroll | One system, one login |
...
## What do I get for 75,000 a month?

Point of sale, customer management, inventory tracking (up to 500 products), expense recording, dashboard with sales reports, and a public online storefront where customers can browse products and place orders. Up to 3 staff accounts. Works fully offline.

---

## Do I need to pay annually?

Monthly is fine. Yearly gives you effectively 2 months free (pay 10 months, get 12).

---

## Is there a free version?

No. There's no free tier. But you get a 30-day free trial to test everything before paying. No credit card required to start.
...
Yes. You control which modules each staff member can access. A cashier sees only the POS. Your inventory manager sees only stock. You (the owner) see everything.
...
## What if my shop has no power or my device breaks?

Custosell runs on any Windows laptop or tablet. Data is stored locally on the device and synced to the cloud when online. If your device fails, install on a new one, log in, and your data restores from the cloud.

---

## How do I pay?

Card payments, mobile money, or bank transfer.

---

## What support do I get?

Essential: email support, 48-hour response. Professional and Enterprise: priority support with faster response.
