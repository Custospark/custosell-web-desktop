export const ROUTES = {
  ...
  EXPENSES: { INDEX: '/expenses', OVERVIEW: '/expenses/overview', INCOME: '/expenses/income', BUDGETS: '/expenses/budgets', MONEY: '/expenses/money', CATEGORIES: '/expenses/categories', LIST: '/expenses/list' },
  DOCUMENTS: {
    INDEX: '/documents',
