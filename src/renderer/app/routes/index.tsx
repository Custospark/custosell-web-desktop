...
import PlatformConversionsPage from '../../modules/platform/PlatformConversionsPage';
...
const HrCompanyAssetDetailPage = lazy(() => import('../../modules/hr/pages/HrCompanyAssetDetailPage'));
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route element={<AuthMiddlewareRoute />}>
        ...
        <Route element={<Layout />}>
          ...
          <Route element={<PlatformAdminRoute />}>
            ...
            <Route path={ROUTES.PLATFORM.CONVERSIONS} element={<SuspenseWrapper><PlatformConversionsPage /></SuspenseWrapper>} />
      ...
      {/* Public /@slug and /@slug/p/<product> share links → in-app pages (must stay after static routes). */}
      <Route path="/:shopHandle/p/:productSlug" element={<ShopShareRedirect />} />
