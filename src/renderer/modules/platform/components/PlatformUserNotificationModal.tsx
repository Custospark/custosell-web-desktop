          ...
          >
            ...
            <div className="flex items-start gap-4 pr-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">
                  Send notification to {users.length} user{users.length === 1 ? '' : 's'}
                </h3>
                <p className="mt-1 text-sm text-gray-500">
                  Reach users via in-app alerts, email, or both — decision tool for outreach and retention.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1">{message.trim().length}/{USER_NOTIFY_MESSAGE_MAX}</p>
