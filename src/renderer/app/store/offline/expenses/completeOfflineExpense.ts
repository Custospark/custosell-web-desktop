...
export function buildLocalExpense(payload: ExpenseFormPayload): ExpenseWithSyncMeta {
  ...
  const expense: Expense = {
    ...
    supplier_tin: payload.fields.supplier_tin ?? null,
    supplier_invoice_no: payload.fields.supplier_invoice_no ?? null,
    vat_amount: payload.fields.vat_amount ?? null,
    vat_claimable: fieldAsBool(payload.fields, 'vat_claimable'),
    receipt_url: null,
    ...
    recurrence_timezone: payload.fields.recurrence_timezone ?? null,
...
export function completeOfflineUpdateExpenseInstant(expense: Expense, formData: FormData): ExpenseWithSyncMeta {
  ...
  const updated: ExpenseWithSyncMeta = {
    ...
    supplier_tin: payload.fields.supplier_tin ?? expense.supplier_tin,
    supplier_invoice_no: payload.fields.supplier_invoice_no ?? expense.supplier_invoice_no,
    vat_amount: payload.fields.vat_amount ?? expense.vat_amount,
    vat_claimable: payload.fields.vat_claimable != null ? fieldAsBool(payload.fields, 'vat_claimable') : expense.vat_claimable,
    is_recurring: fieldAsBool(payload.fields, 'is_recurring'),
    recurrence_interval: payload.fields.recurrence_interval ?? null,
    recurrence_end_date: payload.fields.recurrence_end_date ?? null,
    recurrence_timezone: payload.fields.recurrence_timezone ?? null,
