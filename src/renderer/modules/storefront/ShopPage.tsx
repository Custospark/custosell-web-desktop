      ...
      actions: (
        <div className="flex flex-wrap items-center justify-end gap-1.5">
          {bagCount > 0 ? (
            <button
              type="button"
              className="rounded-md border border-emerald-300/90 bg-gradient-to-r from-emerald-50 via-white to-indigo-50 px-2 py-1.5 text-[11px] font-semibold text-emerald-900 sm:rounded-xl sm:border-2 sm:px-2.5 sm:text-xs"
