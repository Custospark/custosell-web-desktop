...
export const NAV_ITEM_KEYWORDS: Record<string, string[]> = {
  ...
  [ROUTES.SETTINGS.MODULES]: ['custosell apps', 'app store', 'apps', 'module access', 'enable modules', 'module permissions', 'staff modules', 'feature access'],
...
export const MODULE_ALIASES: Record<string, string[]> = {
  ...
  EFRIS: ['efris', 'fiscal', 'fiscalization', 'ura', 'e-invoicing', 'receipt', 'fdn'],
