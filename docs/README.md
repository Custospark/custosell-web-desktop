...
| [2026-08-13-payment-initiate-opens-redirect-url.md](./adr/2026-08-13-payment-initiate-opens-redirect-url.md) | Payment gateway redirects open via a synchronous popup (Google sign-in pattern) so browsers never block them; manual "Open Payment Page" fallback + no hanging on polling |
...
| [2026-08-04-business-social-links.md](./adr/2026-08-04-business-social-links.md) | Settings → Business social links (server-only CRUD); storefront links left of QR; QR download removed from shop page |
