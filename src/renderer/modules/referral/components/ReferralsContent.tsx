...
import { useReferralEarnings, useGenerateReferralCode } from '../api/useReferralQueries';
...
import AccountReferralsWinsTab from '../../account/AccountReferralsWinsTab';
import AccountReferralsPolicyTab from '../../account/AccountReferralsPolicyTab';
import AccountReferralsHelpTab from '../../account/AccountReferralsHelpTab';
...
/**
 * Referral dashboard body (code card + Wins/Policy/Help tabs + QR modal).
 * Shared between the standalone AccountReferralsPage and the Discover
 * ReferralsModal so shopping accounts never need the app sidebar.
 */
