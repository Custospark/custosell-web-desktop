...
export interface Product { id: number; business_id: number; category_id: number | null; name: string; description: string | null; sku: string | null; barcode: string | null; unit_price: string; cost_price: string | null; stock_quantity: number; low_stock_threshold: number; tax_percentage: string; is_active: boolean; category?: Category; }
