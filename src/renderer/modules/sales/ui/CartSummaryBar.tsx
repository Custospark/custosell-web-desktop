  ...
  return (
    <div className="sticky bottom-0 z-10 shrink-0 bg-white pt-3 pb-2 border-t border-gray-200 mt-2 -mx-4 px-4 sm:-mx-6 sm:px-6">
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-3">
        {actions && (
          <div className="hidden lg:flex items-center gap-2 overflow-x-auto overscroll-x-contain w-full min-w-0">
            {actions}
          </div>
        )}
        <div className="flex w-full sm:flex-1 items-center justify-between gap-3 shrink-0">
