...
import { KeyRound, Mail, MoreVertical, Shield, Trash2, UserCog } from 'lucide-react';
...
interface PlatformUserRowActionsProps {
  user: PlatformUser;
  onNotify: () => void;
  onChangeStatus: () => void;
  onAssignRoles: () => void;
        ...
        <>
          ...
          {origin && (
            ...
            >
              ...
              <button type="button" role="menuitem" className={MENU_ITEM_CLASS} onClick={() => { handleClose(); onAssignRoles(); }}>
                <UserCog className="h-4 w-4 text-indigo-600" /> Platform role
              </button>
              <div className="my-1 border-t border-gray-100" />
              <button type="button" role="menuitem" className={MENU_ITEM_CLASS} onClick={() => { handleClose(); onPrivileges(); }}>
                <KeyRound className="h-4 w-4 text-emerald-600" /> Access / privileges
              </button>
              <div className="my-1 border-t border-gray-100" />
