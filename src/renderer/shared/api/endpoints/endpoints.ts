...
export const SUBSCRIPTIONS = { BASE: '/subscriptions', SUBSCRIBE: '/subscriptions/subscribe', UPGRADE: (id: number) => `/subscriptions/${id}/upgrade`, CANCEL: '/subscriptions/cancel' };
