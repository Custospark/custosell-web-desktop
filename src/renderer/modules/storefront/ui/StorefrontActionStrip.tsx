...
const inactiveTone: Record<Tone, string> = {
  slate: 'text-slate-600 active:text-slate-900',
  amber: 'text-amber-700 active:text-amber-900',
  teal: 'text-teal-600 active:text-teal-900',
  emerald: 'text-emerald-600 active:text-emerald-900',
  rose: 'text-rose-600 active:text-rose-900',
  blue: 'text-blue-600 active:text-blue-900',
};
