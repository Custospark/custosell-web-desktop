...
export const storefrontKeys = {
  ...
  discoverPages: (category = '', q = '') => [...storefrontKeys.all, 'discover-pages', category, q] as const,
  ...
  productsPages: (slug: string, category: string, q = '') => [...storefrontKeys.all, 'products-pages', slug, category, q] as const,
