...
export default function HeldOrdersModal({ open, onClose }: Props) {
  ...
  return (
    <Modal
      ...
      bodyClassName="flex flex-col min-h-0 px-4 sm:px-6 py-4"
    >
      <div className="flex flex-col gap-3 min-h-[55vh]">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="shrink-0 flex items-center justify-center gap-1 px-3 py-2 text-xs font-medium text-gray-500 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors whitespace-nowrap"
          >
          ...
          <div className="space-y-2 flex-1 min-h-0 overflow-y-auto max-h-[min(58vh,36rem)] pr-1">
            {filtered.map((order) => {
              ...
              return (
                <div
                  key={order.id}
                  className="flex flex-col sm:flex-row sm:items-start gap-3 p-3.5 bg-white border border-gray-100 rounded-lg hover:border-gray-200 transition-colors"
                >
                  ...
                  {editingId !== order.id && (
                    <div className="flex items-center justify-end gap-1 shrink-0 sm:self-start sm:mt-0.5">
