/**
 * Comprehensive list of world currencies with code, symbol, name, and flag.
 * Single source of truth used by formatCurrency and facility settings.
 */
...
/** Build a lookup map from the list above (used by formatCurrency). */
