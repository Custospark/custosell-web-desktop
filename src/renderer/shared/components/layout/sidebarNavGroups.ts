...
export const baseSubRoutes = [
  ...
  ROUTES.INVENTORY.PRODUCTS, ROUTES.INVENTORY.OVERVIEW, ROUTES.INVENTORY.CATEGORIES, ROUTES.INVENTORY.STOCK,
...
export const guideSettingsNavGroup: SidebarNavGroup = {
  ...
  subItems: [
    ...
    { to: ROUTES.PLATFORM.GUIDE.COMMUNITIES, label: 'Communities', icon: Users },
...
export const baseNavGroups: SidebarNavGroup[] = [
  ...
  },
  {
    ...
    subItems: [
      { to: ROUTES.INVENTORY.OVERVIEW, label: 'Overview', icon: BarChart3 },
  ...
  },
  {
    ...
    subItems: [
      ...
      { to: ROUTES.GUIDE.COMMUNITIES, label: 'Communities', icon: Users },
  ...
  },
  {
    ...
    subItems: [
      ...
      { to: ROUTES.SETTINGS.MODULES, label: 'Custosell Apps', icon: LayoutGrid, ownerOnly: true },
